 ...
 */
public final class ConnectionBuilderWithHeader implements ConnectionBuilder {

    /**
     * The singleton instance of the default connection builder.
     */
    public static final ConnectionBuilderWithHeader INSTANCE = new ConnectionBuilderWithHeader();
    ...
    private ConnectionBuilderWithHeader() {
    ...
    public HttpURLConnection openConnection(@NonNull Uri uri) throws IOException {
        ...
        conn.setRequestProperty("X-Example-Header", "mycustomheadervalue");
        return conn;
    }
}
